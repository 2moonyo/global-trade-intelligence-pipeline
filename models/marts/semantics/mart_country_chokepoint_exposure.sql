...
exposure_metrics as (
  ...
  select
    ...
    {{ safe_divide('ebc.exposed_trade_value_usd', 'ebc.reporter_trade_value_usd') }} * 100 as chokepoint_exposure_pct,
    {{ safe_divide('ebc.high_confidence_exposed_trade_value_usd', 'ebc.exposed_trade_value_usd') }} * 100 as high_confidence_share_pct,
    {{ safe_divide('ebc.medium_confidence_exposed_trade_value_usd', 'ebc.exposed_trade_value_usd') }} * 100 as medium_confidence_share_pct
...
context_signals as (
  ...
  from {{ ref('mart_reporter_month_chokepoint_exposure') }} as rmce
),
ranked_exposure as (
